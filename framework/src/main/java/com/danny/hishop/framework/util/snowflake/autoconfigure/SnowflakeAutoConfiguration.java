package com.danny.hishop.framework.util.snowflake.autoconfigure;

import com.danny.hishop.framework.util.snowflake.autoconfigure.core.Snowflake;
import com.danny.hishop.framework.util.snowflake.autoconfigure.core.SnowflakeProperties;
...
public class SnowflakeAutoConfiguration {
    ...
    public Snowflake snowflake(SnowflakeProperties snowflakeProperties){
        ...
        logger.info("雪花算法starter组件加载完成！开始时间=[{}]", snowflake.getStartTime());
