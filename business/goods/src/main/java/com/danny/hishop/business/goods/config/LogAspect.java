package com.danny.hishop.business.goods.config;
...
public class LogAspect {
    ...
    @Pointcut("execution(* com.danny.hishop.business.goods.controller.*.*(..))")
    public void controllerPointcut() {
    }

    @Pointcut("execution(* com.danny.hishop.business.goods.service.*.*(..))")
